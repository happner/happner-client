(function(isBrowser) {
  ...
  function HappnerClient(opts) {
    ...
    this.__requestTimeout =
      typeof opts.requestTimeout === 'number' ? opts.requestTimeout : 10 * 1000;
    this.__responseTimeout =
      typeof opts.responseTimeout === 'number' ? opts.responseTimeout : 20 * 1000;
  }

  inherits(HappnerClient, EventEmitter);

  HappnerClient.prototype.connect = Promise.promisify(function(connection, options, callback) {
