(function(isBrowser) {
  ...
  ImplementorsProvider.prototype.addPeer = function(name) {
    ...
    var onSuccess = function(description) {
      _this.logDependenciesMet(Object.assign({url: peer.client && peer.client.options?peer.client.options.url:null}, description));
    };
  ...
  ImplementorsProvider.prototype.logDependenciesMet = function(descriptions) {
    if (!this.gotDescriptions || !descriptions) return;
    var _this = this;
