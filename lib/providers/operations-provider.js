(function (isBrowser) {
  ...
  // var Promise // already defined in /api/client
  var semver;
  var RequestBuilder;
  ...
  OperationsProvider.prototype.subscribe = function (component, version, key, handler, callback) {
    ...
    Promise.resolve()
      ...
      .then(function () {
        ...
        _this.connection.client.on(path, options, filterByVersion, callback);
      })
  ...
  OperationsProvider.prototype.request = function (component, version, method, args, callback, origin) {
    ...
    Promise.resolve()
      ...
      .then(function () {
        return _this.executeRequest(implementation, component, method, args, callback, origin);
      })
  ...
  OperationsProvider.prototype.executeRequest = function (implementation, component, method, args, callback, origin) {
    var _this = this;
    return new Promise(function (resolve, reject) {
      ...
      if (!implementation.local) {
        requestArgs = requestArgs
          .withCallbackPeer(_this.implementors.name)
      }
  ...
  OperationsProvider.prototype.subscribeToResponsePaths = function (component, method) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      path += _this.implementors.secure
        ? _this.implementors.domain + '/' + component + '/' + method + '/' + _this.implementors.sessionId + '/*'
      ...
      _this.connection.client.on(path, {event_type: 'set'} , _this.response.bind(_this), function (e) {
